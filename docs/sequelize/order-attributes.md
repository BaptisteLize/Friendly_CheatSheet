...
const tags = await Tag.findAll({
        ...
        order: [["name", "ASC"], ["quizzes", "title", "ASC"]] 
        // dans l'ordre, le tri pour les tag, ensuite l'appel de la table associée via son alias directement et le tri souhaité
      });
```

Si cette syntaxe ne fonctionne pas il faut forcer la reconnaissance du modèle :
...
**! ATTENTION !** - Cela lancera un deuxième appel BDD dans le même controller, niveau perf, pas dingue mais ça fonctionne
...
Autre option, via JS directement - cf : [Méthode sort](https://github.com/BaptisteLize/Friendly_CheatSheet/docs/javascript/sort.md)
